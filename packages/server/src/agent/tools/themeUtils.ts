...
export function generateThemeFromColor(
  ...
  const theme: ThemeConfig = {
    ...
    colors: {
      ...
      accent: { l: isDark ? 0.6 : 0.65, c: Math.min(baseColor.c * 1.5, 0.25), h: (baseColor.h + 10) % 360 },
      ...
      ring: { l: isDark ? 0.55 : 0.5, c: Math.min(baseColor.c * 1.3, 0.2), h: (baseColor.h + 5) % 360 },
