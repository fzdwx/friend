...
/**
 * PlanModifying Component
 *
 * Shows a status indicator when the user is modifying an existing plan.
 */
interface PlanModifyingProps {
  onCancel: () => void;
}

export function PlanModifying({ onCancel }: PlanModifyingProps) {
  const { t } = useTranslation();
